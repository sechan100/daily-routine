...
var RoutineProcessorContext = /** @class */ (function () {
    ...
    RoutineProcessorContext.prototype.remove = function (key) {
...
var _d = obsidian_1.debounce(function (ctx) {
    ...
    core_1.routineMarkdownProcessor.onAllProcessorCalled(ctx);
}, 100, true);
...
function routineMarkdownProcessorEntryPoint(element) {
    ...
    if (!firstProcessorCalled) {
        ...
        core_1.routineMarkdownProcessor.onFirstProcessorCalled(routineProcessorContext);
        firstProcessorCalled = true;
    }
    core_1.routineMarkdownProcessor.processor(element, routineProcessorContext);
