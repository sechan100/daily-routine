...
var struct_processor_1 = require("./struct-processor");
...
var _d = obsidian_1.debounce(function (ctx) {
    ...
    struct_processor_1.routineMarkdownProcessor.onAllProcessorCalled(ctx);
}, 100, true);
...
function routineMarkdownProcessorEntryPoint(element) {
    ...
    if (!firstProcessorCalled) {
        ...
        struct_processor_1.routineMarkdownProcessor.onFirstProcessorCalled(routineProcessorContext);
        firstProcessorCalled = true;
    }
    struct_processor_1.routineMarkdownProcessor.processor(element, routineProcessorContext);
